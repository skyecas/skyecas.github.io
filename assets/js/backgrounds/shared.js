...
var consData = [
  { /* CASSIOPEIA */
    ...
    stars: [
      { name:"Schedar", ra:[0.0, 40.0, 30.39], dec:[56.0, 32.0, 14.7], mag:2.24, spec:"K0II-IIIvar" },
      { name:"Caph", ra:[0.0, 9.0, 10.09], dec:[59.0, 9.0, 0.8], mag:2.28, spec:"F2III-IV" },
      { name:"Tiansi", ra:[0.0, 56.0, 42.5], dec:[60.0, 43.0, 0.3], mag:2.47, spec:"B0IV:evar" },
      { name:"Ruchbah", ra:[1.0, 25.0, 48.6], dec:[60.0, 14.0, 7.5], mag:2.68, spec:"A5Vv SB" },
      { name:"Segin", ra:[1.0, 54.0, 23.68], dec:[63.0, 40.0, 12.5], mag:3.35, spec:"B2pvar" },
      { name:"Achird", ra:[0.0, 49.0, 5.1], dec:[57.0, 48.0, 59.6], mag:3.46, spec:"G0V SB" },
      { name:"F\u00f9l\u00f9 (\u9644\u8def)", ra:[0.0, 36.0, 58.27], dec:[53.0, 53.0, 49.0], mag:3.69, spec:"B2IV" },
      { name:"Gang", ra:[2.0, 3.0, 26.19], dec:[72.0, 25.0, 16.5], mag:3.95, spec:"A2V" },
      { name:"Cexing", ra:[0.0, 32.0, 59.99], dec:[62.0, 55.0, 54.4], mag:4.17, spec:"B1Ia" },
      { name:"Marfak", ra:[1.0, 11.0, 5.93], dec:[55.0, 8.0, 59.8], mag:4.34, spec:"A7Vvar" },
      { name:"Huagai", ra:[2.0, 29.0, 3.99], dec:[67.0, 24.0, 8.6], mag:4.46, spec:"A5p Sr" },
      { name:"triple star", ra:[0.0, 44.0, 43.5], dec:[48.0, 17.0, 3.8], mag:4.48, spec:"B5III" },
      { name:"quadruple star", ra:[2.0, 1.0, 57.55], dec:[70.0, 54.0, 25.4], mag:4.49, spec:"A3IV" },
      { name:"yellow hypergiant", ra:[23.0, 54.0, 23.04], dec:[57.0, 29.0, 57.8], mag:4.51, spec:"F8Ia0-M2I" },
      { name:"Castula", ra:[0.0, 56.0, 40.01], dec:[59.0, 10.0, 52.2], mag:4.62, spec:"G8III-IV" },
      ...
      { name:"\u03bb Cas", ra:[0.0, 31.0, 46.32], dec:[54.0, 31.0, 20.4], mag:4.74, spec:"B8Vn" },
      ...
      { name:"R Cas", ra:[23.0, 58.0, 24.8], dec:[51.0, 23.0, 19.0], mag:4.80, spec:"M6.5-9e" },
      ...
      { name:"Shangcheng", ra:[3.0, 11.0, 56.24], dec:[74.0, 23.0, 37.9], mag:4.85, spec:"A2Vnn" },
      ...
      { name:"septuple star", ra:[23.0, 30.0, 1.92], dec:[58.0, 32.0, 56.1], mag:4.89, spec:"B3IV" },
      ...
      { name:"foreground star appearing among NGC 457", ra:[1.0, 20.0, 4.92], dec:[58.0, 13.0, 53.8], mag:4.95, spec:"F0Ia" },
      ...
      { name:"yellow hypergiant", ra:[23.0, 0.0, 5.1], dec:[56.0, 56.0, 43.4], mag:5.10, spec:"F80" },
      { name:"Marfak", ra:[1.0, 8.0, 12.92], dec:[54.0, 55.0, 27.2], mag:5.17, spec:"G5VIp/M5V" },
      ...
      { name:"Rangifer", ra:[2.0, 5.0, 31.58], dec:[76.0, 6.0, 54.4], mag:5.22, spec:"G8III" },
      { name:"47 Cas", ra:[2.0, 5.0, 7.05], dec:[77.0, 16.0, 53.2], mag:5.27, spec:"F0Vn" },
      { name:"40 Cas", ra:[1.0, 38.0, 30.94], dec:[73.0, 2.0, 24.3], mag:5.28, spec:"G8II-III" },
      { name:"HD 11946", ra:[1.0, 59.0, 37.99], dec:[64.0, 37.0, 17.9], mag:5.29, spec:"A0Vn" },
      { name:"31 Cas", ra:[1.0, 10.0, 39.27], dec:[68.0, 46.0, 43.3], mag:5.32, spec:"A0Vnn" },
      { name:"HD 4775", ra:[0.0, 50.0, 43.57], dec:[64.0, 14.0, 51.3], mag:5.35, spec:"A4V comp SB" },
      { name:"12 Cas", ra:[0.0, 24.0, 47.49], dec:[61.0, 49.0, 51.8], mag:5.38, spec:"B9III" },
      { name:"HD 4222", ra:[0.0, 45.0, 17.2], dec:[55.0, 13.0, 17.1], mag:5.41, spec:"A2Vs" },
      { name:"23 Cas", ra:[0.0, 47.0, 46.02], dec:[74.0, 50.0, 51.3], mag:5.42, spec:"B8III" },
      { name:"6 Cas", ra:[23.0, 48.0, 50.17], dec:[62.0, 12.0, 52.3], mag:5.43, spec:"A3Ia comp" },
  ...
  { /* ORION */
    ...
    stars: [
      { name:"Rigel", ra:[5.0, 14.0, 32.27], dec:[-8.0, 12.0, 5.9], mag:0.18, spec:"B8Ia + B9V + B9V" },
      ...
      { name:"Mintaka AB", ra:[5.0, 32.0, 0.4], dec:[-0.0, 17.0, 56.7], mag:2.20, spec:"B0III+O9V" },
      ...
      { name:"Saif al Jabbar", ra:[5.0, 24.0, 28.62], dec:[-2.0, 23.0, 49.7], mag:3.35, spec:"B1V + B2" },
      ...
      { name:"Alnitak B", ra:[5.0, 40.0, 45.6], dec:[-1.0, 56.0, 34.0], mag:3.70, spec:"B0III+B1IV" },
      ...
      { name:"\u03c62 Ori", ra:[5.0, 36.0, 54.33], dec:[9.0, 17.0, 29.1], mag:4.09, spec:"G8III-IV" },
      { name:"\u03bc Ori", ra:[6.0, 2.0, 22.99], dec:[9.0, 38.0, 50.5], mag:4.12, spec:"Am..." },
      ...
      { name:"\u03c02 Ori", ra:[4.0, 50.0, 36.72], dec:[8.0, 54.0, 0.9], mag:4.35, spec:"A1Vn" },
      ...
      { name:"\u03c06 Ori", ra:[4.0, 58.0, 32.9], dec:[1.0, 42.0, 50.5], mag:4.47, spec:"K2IIvar" },
      { name:"\u03c9 Ori", ra:[5.0, 39.0, 11.15], dec:[4.0, 7.0, 17.3], mag:4.50, spec:"B3IIIe" },
      { name:"HD 40657", ra:[6.0, 0.0, 3.35], dec:[-3.0, 4.0, 26.7], mag:4.53, spec:"K2IIIvar" },
      ...
      { name:"11 Ori", ra:[5.0, 4.0, 34.14], dec:[15.0, 24.0, 15.1], mag:4.65, spec:"A0p Si" },
      { name:"\u03bf1 Ori", ra:[4.0, 52.0, 31.96], dec:[14.0, 15.0, 2.8], mag:4.71, spec:"M3Sv" },
      { name:"31 Ori", ra:[5.0, 29.0, 43.98], dec:[-1.0, 5.0, 31.8], mag:4.71, spec:"K5III" },
      { name:"22 Ori", ra:[5.0, 21.0, 45.75], dec:[-0.0, 22.0, 56.9], mag:4.72, spec:"B2IV-V" },
      { name:"56 Ori", ra:[5.0, 52.0, 26.44], dec:[1.0, 51.0, 18.6], mag:4.76, spec:"K2IIvar" },
      ...
      { name:"\u03c81 Ori", ra:[5.0, 24.0, 44.83], dec:[1.0, 50.0, 47.2], mag:4.89, spec:"B1V:pe" },
      ...
      { name:"HD 37756", ra:[5.0, 40.0, 50.72], dec:[-1.0, 7.0, 43.6], mag:4.95, spec:"B2IV-V" },
      { name:"69 Ori", ra:[6.0, 12.0, 3.28], dec:[16.0, 7.0, 49.6], mag:4.95, spec:"B5Vn" },
      { name:"\u03b82 Ori", ra:[5.0, 35.0, 22.9], dec:[-5.0, 24.0, 57.8], mag:4.98, spec:"O9.5Vpe" },
      { name:"23 Ori", ra:[5.0, 22.0, 50.0], dec:[3.0, 32.0, 40.0], mag:5.00, spec:"B1V" },
      { name:"74 Ori", ra:[6.0, 16.0, 26.57], dec:[12.0, 16.0, 18.2], mag:5.04, spec:"F5IV-V" },
      { name:"27 Ori", ra:[5.0, 24.0, 28.91], dec:[-0.0, 53.0, 30.0], mag:5.07, spec:"K0III" },
      { name:"\u03b81 Ori C", ra:[5.0, 35.0, 16.47], dec:[-5.0, 23.0, 22.9], mag:5.13, spec:"O6Vpe" },
      ...
      { name:"60 Ori", ra:[5.0, 58.0, 49.58], dec:[0.0, 33.0, 10.7], mag:5.21, spec:"A1Vs" },
      ...
      { name:"14 Ori", ra:[5.0, 7.0, 52.87], dec:[8.0, 29.0, 54.9], mag:5.33, spec:"Am" },
      { name:"21 Ori", ra:[5.0, 19.0, 11.23], dec:[2.0, 35.0, 45.4], mag:5.34, spec:"F5IIvar" },
      ...
      { name:"HD 30210", ra:[4.0, 46.0, 1.7], dec:[11.0, 42.0, 20.2], mag:5.35, spec:"Am..." },
      { name:"VV Ori", ra:[5.0, 33.0, 31.45], dec:[-1.0, 9.0, 21.9], mag:5.36, spec:"B1V" },
      { name:"55 Ori", ra:[5.0, 51.0, 21.98], dec:[-7.0, 31.0, 4.8], mag:5.36, spec:"B2IV-V" },
      ...
      { name:"16 Ori", ra:[5.0, 9.0, 19.6], dec:[9.0, 49.0, 46.6], mag:5.43, spec:"A2m" },
      { name:"73 Ori", ra:[6.0, 15.0, 44.97], dec:[12.0, 33.0, 3.9], mag:5.44, spec:"B9II-III" },
  ...
  { /* LYRA */
    ...
    stars: [
      { name:"Vega", ra:[18.0, 36.0, 56.19], dec:[38.0, 46.0, 58.8], mag:0.03, spec:"A0Vvar" },
      { name:"Sulafat", ra:[18.0, 58.0, 56.62], dec:[32.0, 41.0, 22.4], mag:3.25, spec:"B9III" },
      { name:"Sheliak", ra:[18.0, 50.0, 4.79], dec:[33.0, 21.0, 45.6], mag:3.52, spec:"A8:V comp SB" },
      { name:"R Lyr", ra:[18.0, 55.0, 20.09], dec:[43.0, 56.0, 45.2], mag:4.08, spec:"M5IIIvar" },
      { name:"\u03b42 Lyr", ra:[18.0, 54.0, 30.29], dec:[36.0, 53.0, 55.0], mag:4.22, spec:"M4IIvar" },
      { name:"\u03ba Lyr", ra:[18.0, 19.0, 51.72], dec:[36.0, 3.0, 52.0], mag:4.33, spec:"K2IIIvar" },
      { name:"\u03b61 Lyr", ra:[18.0, 44.0, 46.34], dec:[37.0, 36.0, 18.2], mag:4.34, spec:"Am" },
      ...
      { name:"\u03b52 Lyr A", ra:[18.0, 44.0, 22.78], dec:[39.0, 36.0, 45.3], mag:4.60, spec:"A8Vn" },
      { name:"\u03b51 Lyr A", ra:[18.0, 44.0, 20.34], dec:[39.0, 40.0, 11.9], mag:4.67, spec:"F1V" },
      ...
      { name:"Alathfar", ra:[18.0, 24.0, 13.8], dec:[39.0, 30.0, 26.1], mag:5.11, spec:"A3IVn" },
      { name:"has a planet (b)", ra:[18.0, 57.0, 1.47], dec:[32.0, 54.0, 5.8], mag:5.20, spec:"G0V" },
      ...
      { name:"Be star", ra:[19.0, 7.0, 18.13], dec:[36.0, 6.0, 0.6], mag:5.25, spec:"B6IV" },
      { name:"HD 176527", ra:[18.0, 59.0, 45.43], dec:[26.0, 13.0, 49.6], mag:5.26, spec:"K2III" },
      { name:"\u03b52 Lyr B", ra:[18.0, 44.0, 22.9], dec:[39.0, 36.0, 46.0], mag:5.37, spec:null },
      { name:"HD 172044", ra:[18.0, 36.0, 37.35], dec:[33.0, 28.0, 8.5], mag:5.41, spec:"B8II-IIIp.." },
  ...
  { /* CYGNUS */
    ...
    stars: [
      ...
      { name:"Albireo", ra:[19.0, 30.0, 43.29], dec:[27.0, 57.0, 34.9], mag:3.05, spec:"K3II+..." },
      { name:"multiple star", ra:[21.0, 12.0, 56.18], dec:[30.0, 13.0, 37.5], mag:3.21, spec:"G8II SB" },
      { name:"\u03be Cyg", ra:[21.0, 4.0, 55.86], dec:[43.0, 55.0, 40.3], mag:3.72, spec:"K5Ibv SB" },
      { name:"multiple star", ra:[21.0, 14.0, 47.35], dec:[38.0, 2.0, 39.6], mag:3.74, spec:"F1IV" },
      { name:"\u03b9 Cyg", ra:[19.0, 29.0, 42.34], dec:[51.0, 43.0, 46.1], mag:3.76, spec:"A5Vn" },
      ...
      { name:"multiple star", ra:[19.0, 56.0, 18.4], dec:[35.0, 5.0, 0.6], mag:3.89, spec:"K0IIIvar" },
      { name:"\u03bd Cyg", ra:[20.0, 57.0, 10.41], dec:[41.0, 10.0, 1.9], mag:3.94, spec:"A1Vn" },
      { name:"\u03bf2 Cyg", ra:[20.0, 15.0, 28.32], dec:[47.0, 42.0, 51.1], mag:3.96, spec:"K3Ib-II comp" },
      ...
      { name:"double star", ra:[20.0, 45.0, 39.76], dec:[30.0, 43.0, 10.8], mag:4.22, spec:"K0III" },
      { name:"\u03c3 Cyg", ra:[21.0, 17.0, 24.95], dec:[39.0, 23.0, 40.9], mag:4.22, spec:"B9Iab" },
      { name:"Pennae Caudalis", ra:[21.0, 46.0, 47.61], dec:[49.0, 18.0, 34.5], mag:4.23, spec:"B3III" },
      { name:"33 Cyg", ra:[20.0, 13.0, 23.8], dec:[56.0, 34.0, 3.1], mag:4.28, spec:"A3IV-Vn" },
      { name:"emission-line star", ra:[21.0, 17.0, 55.07], dec:[34.0, 53.0, 48.8], mag:4.41, spec:"B2Vne" },
      { name:"39 Cyg", ra:[20.0, 23.0, 51.6], dec:[32.0, 11.0, 24.7], mag:4.43, spec:"K3III" },
      { name:"triple star", ra:[19.0, 36.0, 26.54], dec:[50.0, 13.0, 13.7], mag:4.49, spec:"F4V" },
      { name:"Be star", ra:[20.0, 47.0, 24.53], dec:[36.0, 29.0, 26.7], mag:4.53, spec:"B6IV" },
      { name:"double star", ra:[21.0, 6.0, 36.09], dec:[47.0, 38.0, 54.3], mag:4.56, spec:"K4II" },
      { name:"double star", ra:[20.0, 33.0, 54.19], dec:[35.0, 15.0, 3.1], mag:4.61, spec:"K2Ib comp" },
      { name:"\u03c6 Cyg", ra:[19.0, 39.0, 22.6], dec:[30.0, 9.0, 11.6], mag:4.68, spec:"G8III-IV..." },
      { name:"Azelfafage", ra:[21.0, 42.0, 5.66], dec:[51.0, 11.0, 22.7], mag:4.69, spec:"B3IV" },
      { name:"multiple star", ra:[21.0, 44.0, 8.59], dec:[28.0, 44.0, 33.4], mag:4.69, spec:"F6V" },
      { name:"8 Cyg", ra:[19.0, 31.0, 46.32], dec:[34.0, 27.0, 10.7], mag:4.74, spec:"B3IV" },
      { name:"59 Cyg", ra:[20.0, 59.0, 49.55], dec:[47.0, 31.0, 15.4], mag:4.74, spec:"B1ne" },
      { name:"Nova Cygni 1600", ra:[20.0, 17.0, 47.2], dec:[38.0, 1.0, 58.6], mag:4.77, spec:"B2pe" },
      { name:"30 Cyg", ra:[20.0, 13.0, 18.04], dec:[46.0, 48.0, 56.4], mag:4.80, spec:"A5IIIn" },
      ...
      { name:"multiple star", ra:[19.0, 55.0, 37.82], dec:[52.0, 26.0, 20.5], mag:4.91, spec:"A4Vn" },
      { name:"Be star", ra:[20.0, 9.0, 25.62], dec:[36.0, 50.0, 22.5], mag:4.93, spec:"B2.5V" },
      { name:"29 Cyg", ra:[20.0, 14.0, 31.98], dec:[36.0, 48.0, 22.1], mag:4.93, spec:"A2V" },
      { name:"triple star", ra:[20.0, 47.0, 10.72], dec:[34.0, 22.0, 26.8], mag:4.93, spec:"K3IIIvar" },
      ...
      { name:"HD 189276", ra:[19.0, 55.0, 55.39], dec:[58.0, 50.0, 45.7], mag:4.98, spec:"K5II-III" },
      { name:"double star", ra:[19.0, 24.0, 7.57], dec:[29.0, 37.0, 16.7], mag:4.99, spec:"B3IV" },
      { name:"17 Cyg", ra:[19.0, 46.0, 25.58], dec:[33.0, 43.0, 43.3], mag:5.00, spec:"F5" },
      { name:"20 Cyg", ra:[19.0, 50.0, 37.73], dec:[52.0, 59.0, 17.4], mag:5.03, spec:"K3IIIvar" },
      { name:"68 Cyg", ra:[21.0, 18.0, 27.18], dec:[43.0, 56.0, 45.5], mag:5.04, spec:"O8e" },
      { name:"74 Cyg", ra:[21.0, 36.0, 56.98], dec:[40.0, 24.0, 48.6], mag:5.04, spec:"A5V" },
      { name:"", ra:[19.0, 40.0, 50.11], dec:[45.0, 31.0, 28.7], mag:5.06, spec:"F5II" },
      { name:"multiple star", ra:[20.0, 1.0, 21.55], dec:[50.0, 6.0, 16.8], mag:5.06, spec:"K1II-III" },
      { name:"double star", ra:[20.0, 50.0, 4.83], dec:[44.0, 3.0, 32.3], mag:5.06, spec:"A4me..." },
      { name:"triple star", ra:[21.0, 40.0, 11.06], dec:[43.0, 16.0, 25.7], mag:5.09, spec:"M1IIIvar" },
      { name:"Albireo", ra:[19.0, 30.0, 45.4], dec:[27.0, 57.0, 55.0], mag:5.12, spec:"B8V" },
      ...
      { name:"4 Cyg", ra:[19.0, 26.0, 9.12], dec:[36.0, 19.0, 4.3], mag:5.17, spec:"B9sp..." },
      { name:"", ra:[19.0, 36.0, 38.05], dec:[44.0, 41.0, 42.7], mag:5.17, spec:"K0III" },
      { name:"19 Cyg", ra:[19.0, 50.0, 33.99], dec:[38.0, 43.0, 19.8], mag:5.18, spec:"M2IIIa" },
      { name:"Bessel's Star", ra:[21.0, 6.0, 50.84], dec:[38.0, 44.0, 29.4], mag:5.20, spec:"K5V" },
      { name:"71 Cyg", ra:[21.0, 29.0, 26.91], dec:[46.0, 32.0, 25.2], mag:5.22, spec:"K0III" },
      { name:"", ra:[20.0, 16.0, 55.28], dec:[40.0, 21.0, 54.3], mag:5.27, spec:"K5II" },
      { name:"", ra:[21.0, 26.0, 51.57], dec:[48.0, 50.0, 6.4], mag:5.29, spec:"A6pe..." },
      { name:"70 Cyg", ra:[21.0, 27.0, 21.36], dec:[37.0, 7.0, 0.5], mag:5.30, spec:"B3V" },
      { name:"", ra:[19.0, 34.0, 41.26], dec:[42.0, 24.0, 45.3], mag:5.34, spec:"A2V" },
      ...
      { name:"multiple star", ra:[20.0, 42.0, 12.63], dec:[50.0, 20.0, 24.1], mag:5.41, spec:"B2V" },
      { name:"double star", ra:[19.0, 57.0, 13.86], dec:[40.0, 22.0, 4.2], mag:5.46, spec:"B5V" },
      { name:"", ra:[20.0, 53.0, 53.91], dec:[33.0, 26.0, 16.1], mag:5.47, spec:"K5III" },
      { name:"", ra:[20.0, 53.0, 18.56], dec:[45.0, 10.0, 54.1], mag:5.48, spec:"K0II" },
    ],
  ...
  { /* GEMINI */
    ...
    stars: [
      ...
      { name:"Castor A", ra:[7.0, 34.0, 36.0], dec:[31.0, 53.0, 19.1], mag:1.90, spec:"A2Vm" },
      ...
      { name:"Castor B", ra:[7.0, 34.0, 36.0], dec:[31.0, 53.0, 19.0], mag:2.88, spec:"Am" },
      ...
      { name:"Propus", ra:[6.0, 4.0, 7.22], dec:[23.0, 15.0, 49.1], mag:4.16, spec:"G7III" },
      { name:"\u03c1 Gem", ra:[7.0, 29.0, 6.61], dec:[31.0, 47.0, 2.7], mag:4.16, spec:"F0V..." },
      { name:"\u03c3 Gem", ra:[7.0, 43.0, 18.69], dec:[28.0, 53.0, 2.7], mag:4.23, spec:"K1III SB" },
      ...
      { name:"38 Gem", ra:[6.0, 54.0, 38.59], dec:[13.0, 10.0, 40.9], mag:4.71, spec:"F0Vp" },
      ...
      { name:"63 Gem", ra:[7.0, 27.0, 44.39], dec:[21.0, 26.0, 44.0], mag:5.20, spec:"F5IV-V..." },
      { name:"68 Gem", ra:[7.0, 33.0, 36.5], dec:[15.0, 49.0, 36.1], mag:5.27, spec:"A1Vn" },
      ...
      { name:"85 Gem", ra:[7.0, 55.0, 39.9], dec:[19.0, 53.0, 2.6], mag:5.38, spec:"A0Vs" },
      { name:"28 Gem", ra:[6.0, 44.0, 45.46], dec:[28.0, 58.0, 15.6], mag:5.42, spec:"K4III" },
      { name:"has a planet (b)", ra:[7.0, 31.0, 48.37], dec:[17.0, 5.0, 10.4], mag:5.45, spec:"K2III" },
  ...
  { /* SCORPIUS */
    ...
    stars: [
      { name:"Antares", ra:[16.0, 29.0, 24.47], dec:[-26.0, 25.0, 55.0], mag:0.91, spec:"M1.5Iab-b" },
      { name:"Shaula", ra:[17.0, 33.0, 36.53], dec:[-37.0, 6.0, 13.5], mag:1.62, spec:"B2IV+DA7.9" },
      { name:"Sargas", ra:[17.0, 37.0, 19.13], dec:[-42.0, 59.0, 52.2], mag:1.86, spec:"F1II" },
      { name:"Dschubba", ra:[16.0, 0.0, 20.01], dec:[-22.0, 37.0, 17.8], mag:2.29, spec:"B0.2IVe" },
      ...
      { name:"Fang", ra:[15.0, 58.0, 51.12], dec:[-26.0, 6.0, 50.6], mag:2.89, spec:"B1V + B2V" },
      ...
      { name:"Xamidimura", ra:[16.0, 51.0, 52.24], dec:[-38.0, 2.0, 50.4], mag:3.00, spec:"B1.5IV + B" },
      { name:"\u03b3 Tel", ra:[17.0, 49.0, 51.45], dec:[-37.0, 2.0, 36.1], mag:3.19, spec:"K0/K1III" },
      { name:"\u03b7 Sco", ra:[17.0, 12.0, 9.18], dec:[-43.0, 14.0, 18.6], mag:3.32, spec:"F3p" },
      ...
      { name:"Iklil", ra:[15.0, 56.0, 53.09], dec:[-29.0, 12.0, 50.4], mag:3.87, spec:"B2IV/V" },
      ...
      { name:"\u03b2 Nor", ra:[16.0, 36.0, 22.46], dec:[-35.0, 15.0, 19.3], mag:4.18, spec:"K5III" },
      { name:"\u03b1 Nor", ra:[16.0, 31.0, 22.94], dec:[-34.0, 42.0, 15.6], mag:4.24, spec:"B2III-IV" },
      { name:"Q Sco", ra:[17.0, 36.0, 32.85], dec:[-38.0, 38.0, 5.5], mag:4.26, spec:"G8/K0III/IV" },
      { name:"Jabhat al Akrab", ra:[16.0, 7.0, 24.3], dec:[-20.0, 52.0, 7.2], mag:4.31, spec:"G6/G8III" },
      { name:"\u03bf Sco", ra:[16.0, 20.0, 38.18], dec:[-24.0, 10.0, 9.4], mag:4.55, spec:"A4II/III" },
      { name:"13 Sco", ra:[16.0, 12.0, 18.21], dec:[-27.0, 55.0, 34.7], mag:4.58, spec:"B2V" },
      { name:"2 Sco", ra:[15.0, 53.0, 36.73], dec:[-25.0, 19.0, 37.5], mag:4.59, spec:"B2.5Vn" },
      { name:"1 Sco", ra:[15.0, 50.0, 58.75], dec:[-25.0, 45.0, 4.4], mag:4.63, spec:"B1.5Vn" },
      { name:"in NGC 6231", ra:[16.0, 53.0, 59.73], dec:[-42.0, 21.0, 43.3], mag:4.70, spec:"B1Iae" },
      { name:"51 Lib", ra:[16.0, 4.0, 22.1], dec:[-11.0, 22.0, 23.0], mag:4.77, spec:null },
      ...
      { name:"Xi Telescopii", ra:[17.0, 49.0, 10.47], dec:[-31.0, 42.0, 11.5], mag:4.79, spec:"B8Ib/II" },
      { name:"HD 146624", ra:[16.0, 18.0, 17.92], dec:[-28.0, 36.0, 49.6], mag:4.80, spec:"A0V:" },
      { name:"V1073 Sco", ra:[17.0, 4.0, 49.35], dec:[-34.0, 7.0, 22.5], mag:4.83, spec:"B2Iab" },
      ...
      { name:"\u03b22 Sco", ra:[16.0, 5.0, 26.58], dec:[-19.0, 48.0, 6.6], mag:4.90, spec:"B2V" },
      ...
      { name:"HD 154948", ra:[17.0, 10.0, 42.35], dec:[-44.0, 33.0, 27.2], mag:5.06, spec:"G8/K0III+.." },
      { name:"\u03be Sco B", ra:[16.0, 4.0, 22.3], dec:[-11.0, 22.0, 18.0], mag:5.07, spec:"F5IV" },
      ...
      { name:"Antares", ra:[16.0, 29.0, 24.2], dec:[-26.0, 25.0, 51.0], mag:5.20, spec:"B2.5V" },
      { name:"HD 151804", ra:[16.0, 51.0, 33.72], dec:[-41.0, 13.0, 49.9], mag:5.23, spec:"O8Iaf" },
      { name:"Has a planet (b)", ra:[16.0, 13.0, 50.91], dec:[-11.0, 50.0, 15.8], mag:5.24, spec:"K3III" },
      ...
      { name:"has a planet (b)", ra:[16.0, 24.0, 1.24], dec:[-39.0, 11.0, 34.8], mag:5.37, spec:"G3/G5V" },
      ...
      { name:"in NGC 6231", ra:[16.0, 54.0, 1.84], dec:[-41.0, 48.0, 23.0], mag:5.46, spec:"B0.5Ia" },
      ...
      { name:"solar twin", ra:[16.0, 15.0, 37.13], dec:[-8.0, 22.0, 5.7], mag:5.49, spec:"G1V" },
  ...
  { /* ANDROMEDA */
    ...
    stars: [
      { name:"Alpheratz", ra:[0.0, 8.0, 23.17], dec:[29.0, 5.0, 27.0], mag:2.07, spec:"B9p" },
      { name:"Mirach", ra:[1.0, 9.0, 43.8], dec:[35.0, 37.0, 15.0], mag:2.07, spec:"M0IIIvar" },
      ...
      { name:"BD+40\u00b0148", ra:[0.0, 42.0, 44.31], dec:[41.0, 16.0, 9.4], mag:3.44, spec:null },
      { name:"Nembus", ra:[1.0, 37.0, 59.5], dec:[48.0, 37.0, 42.6], mag:3.59, spec:"K3III" },
      { name:"Alfarasalkamil", ra:[23.0, 1.0, 55.25], dec:[42.0, 19.0, 33.5], mag:3.62, spec:"B6pv SB" },
      { name:"Udkadua", ra:[23.0, 37.0, 33.71], dec:[46.0, 27.0, 33.0], mag:3.81, spec:"G8III-IV" },
      { name:"multiple star", ra:[0.0, 56.0, 45.1], dec:[38.0, 29.0, 57.3], mag:3.86, spec:"A5V" },
      ...
      { name:"Kaffalmusalsala", ra:[23.0, 40.0, 24.44], dec:[44.0, 20.0, 2.3], mag:4.15, spec:"B9IVn" },
      ...
      { name:"Kui", ra:[0.0, 57.0, 12.43], dec:[23.0, 25.0, 3.9], mag:4.40, spec:"G8III-IV" },
      { name:"\u03c3 And", ra:[0.0, 18.0, 19.71], dec:[36.0, 47.0, 7.2], mag:4.51, spec:"A2V" },
      { name:"\u03bd And", ra:[0.0, 49.0, 48.83], dec:[41.0, 4.0, 44.2], mag:4.53, spec:"B5V SB" },
      { name:"Honores", ra:[23.0, 12.0, 32.92], dec:[49.0, 24.0, 21.5], mag:4.53, spec:"F0V" },
      ...
      { name:"triple star", ra:[2.0, 25.0, 37.4], dec:[50.0, 16.0, 43.2], mag:4.73, spec:"K4III" },
      { name:"58 And", ra:[2.0, 8.0, 29.15], dec:[37.0, 51.0, 33.1], mag:4.78, spec:"A5IV-V" },
      ...
      { name:"\u03b32 And", ra:[2.0, 3.0, 54.7], dec:[42.0, 19.0, 51.0], mag:4.84, spec:"B8V" },
      { name:"60 And", ra:[2.0, 13.0, 13.34], dec:[44.0, 13.0, 54.1], mag:4.84, spec:"K4III" },
      { name:"Adhil", ra:[1.0, 22.0, 20.39], dec:[45.0, 31.0, 43.5], mag:4.87, spec:"K0III-IV" },
      ...
      { name:"multiple star", ra:[23.0, 46.0, 2.04], dec:[46.0, 25.0, 13.0], mag:4.97, spec:"G5Ib" },
      ...
      { name:"41 And", ra:[1.0, 8.0, 0.72], dec:[43.0, 56.0, 32.1], mag:5.04, spec:"A3m" },
      { name:"multiple star", ra:[23.0, 2.0, 36.34], dec:[42.0, 45.0, 28.1], mag:5.09, spec:"A3Vn" },
      ...
      { name:"HD 2421", ra:[0.0, 28.0, 13.59], dec:[44.0, 23.0, 40.2], mag:5.18, spec:"A2Vs" },
      ...
      { name:"Veritate", ra:[23.0, 31.0, 17.2], dec:[39.0, 14.0, 11.0], mag:5.22, spec:"K0III" },
      ...
      { name:"double star", ra:[23.0, 7.0, 39.28], dec:[46.0, 23.0, 14.3], mag:5.30, spec:"K5III" },
      { name:"6 Per", ra:[2.0, 13.0, 36.02], dec:[51.0, 3.0, 58.4], mag:5.31, spec:"G8III:var" },
      ...
      { name:"double star", ra:[1.0, 53.0, 17.35], dec:[40.0, 43.0, 47.3], mag:5.42, spec:"K1III" },
      { name:"11 And", ra:[23.0, 19.0, 29.79], dec:[48.0, 37.0, 30.7], mag:5.44, spec:"K0III" },
      { name:"", ra:[0.0, 37.0, 21.23], dec:[35.0, 23.0, 58.2], mag:5.45, spec:"G5III" },
