...
var consData = [
  ...
  { /* ORION */
    ...
    stars: [
      ...
      { name:"suspected variable", ra:[5.0, 24.0, 28.91], dec:[-0.0, 53.0, 30.0], mag:5.07, spec:"K0III" },
      { name:"\u03b81 Ori C", ra:[5.0, 35.0, 16.47], dec:[-5.0, 23.0, 22.9], mag:5.13, spec:"O6Vpe" },
      { name:"suspected variable", ra:[6.0, 3.0, 27.36], dec:[19.0, 41.0, 26.2], mag:5.14, spec:"B8V" },
      { name:"suspected variable", ra:[4.0, 54.0, 46.91], dec:[11.0, 25.0, 33.5], mag:5.18, spec:"A3V" },
      { name:"HD 33554", ra:[5.0, 11.0, 41.56], dec:[16.0, 2.0, 44.4], mag:5.18, spec:"K5III" },
      { name:"suspected variable", ra:[5.0, 58.0, 49.58], dec:[0.0, 33.0, 10.7], mag:5.21, spec:"A1Vs" },
      { name:"suspected variable", ra:[4.0, 53.0, 22.76], dec:[2.0, 30.0, 29.8], mag:5.33, spec:"M1III" },
      ...
      { name:"suspected variable", ra:[5.0, 51.0, 21.98], dec:[-7.0, 31.0, 4.8], mag:5.36, spec:"B2IV-V" },
      ...
      { name:"suspected variable", ra:[5.0, 9.0, 19.6], dec:[9.0, 49.0, 46.6], mag:5.43, spec:"A2m" },
  ...
  { /* CYGNUS */
    ...
    stars: [
      ...
      { name:"variable", ra:[19.0, 40.0, 50.11], dec:[45.0, 31.0, 28.7], mag:5.06, spec:"F5II" },
      ...
      { name:"variable", ra:[20.0, 16.0, 55.28], dec:[40.0, 21.0, 54.3], mag:5.27, spec:"K5II" },
      { name:"\u03b12CVn variable", ra:[21.0, 26.0, 51.57], dec:[48.0, 50.0, 6.4], mag:5.29, spec:"A6pe..." },
