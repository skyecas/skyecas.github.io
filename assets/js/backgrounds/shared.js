...
var consData = [
    ...
    stars: [
      ...
      { name:"\u03b81 Ori C", ra:[5.0, 35.0, 16.47], dec:[-5.0, 23.0, 22.9], mag:5.13, spec:"O6V" },
    ...
    stars: [
      ...
      { name:"Schedar", ra:[1.0, 54.0, 23.68], dec:[63.0, 40.0, 12.5], mag:3.35, spec:"B2" },
      { name:"Tiansi", ra:[0.0, 40.0, 30.39], dec:[56.0, 32.0, 14.7], mag:2.24, spec:"K0II" },
      { name:"Ruchbah", ra:[0.0, 56.0, 42.5], dec:[60.0, 43.0, 0.3], mag:2.47, spec:"B0IV" },
      { name:"Segin", ra:[0.0, 9.0, 10.09], dec:[59.0, 9.0, 0.8], mag:2.28, spec:"F2III" },
      { name:"\u03b7 Cas", ra:[0.0, 49.0, 5.1], dec:[57.0, 48.0, 59.6], mag:3.46, spec:"G0V" },
      ...
      { name:"\u03b8 Cas", ra:[1.0, 11.0, 5.93], dec:[55.0, 8.0, 59.8], mag:4.34, spec:"A7V" },
      { name:"\u03b9 Cas", ra:[2.0, 29.0, 3.99], dec:[67.0, 24.0, 8.6], mag:4.46, spec:"A5" },
      ...
      { name:"\u03c1 Cas", ra:[23.0, 54.0, 23.04], dec:[57.0, 29.0, 57.8], mag:4.51, spec:"F8Ia" },
      { name:"\u03c52 Cas", ra:[0.0, 56.0, 40.01], dec:[59.0, 10.0, 52.2], mag:4.62, spec:"G8III" },
      ...
      { name:"\u03bc Cas", ra:[1.0, 8.0, 12.92], dec:[54.0, 55.0, 27.2], mag:5.17, spec:"G5VI" },
    ...
    stars: [
      ...
      { name:"\u03b52 Lyr A", ra:[18.0, 44.0, 22.78], dec:[39.0, 36.0, 45.3], mag:4.60, spec:"A8V" },
      ...
      { name:"\u03bc Lyr", ra:[18.0, 24.0, 13.8], dec:[39.0, 30.0, 26.1], mag:5.11, spec:"A3IV" },
    ...
    stars: [
      ...
      { name:"Albireo", ra:[20.0, 46.0, 12.43], dec:[33.0, 58.0, 10.0], mag:2.48, spec:"K0III" },
      { name:"Fawaris", ra:[19.0, 17.0, 6.11], dec:[53.0, 22.0, 5.4], mag:3.80, spec:"K0III" },
      { name:"Aljanah", ra:[19.0, 29.0, 42.34], dec:[51.0, 43.0, 46.1], mag:3.76, spec:"A5V" },
    ...
    stars: [
      ...
      { name:"Alhena", ra:[6.0, 45.0, 17.43], dec:[12.0, 53.0, 45.8], mag:3.35, spec:"F5IV" },
      { name:"Wasat", ra:[7.0, 35.0, 55.37], dec:[26.0, 53.0, 45.6], mag:4.06, spec:"K5III" },
      { name:"Mebsuta", ra:[7.0, 20.0, 7.39], dec:[21.0, 58.0, 56.4], mag:3.50, spec:"F0IV" },
    ...
    stars: [
      ...
      { name:"Antares", ra:[16.0, 29.0, 24.47], dec:[-26.0, 25.0, 55.0], mag:0.91, spec:"M1.5Ia" },
      { name:"Wei", ra:[15.0, 58.0, 51.12], dec:[-26.0, 6.0, 50.6], mag:2.89, spec:"B1V" },
      ...
      { name:"\u03c92 Sco", ra:[16.0, 7.0, 24.3], dec:[-20.0, 52.0, 7.2], mag:4.31, spec:"G6" },
    ...
    stars: [
      ...
      { name:"Mirach", ra:[0.0, 39.0, 19.6], dec:[30.0, 51.0, 40.4], mag:3.27, spec:"K3III" },
      { name:"Almach", ra:[1.0, 9.0, 43.8], dec:[35.0, 37.0, 15.0], mag:2.07, spec:"M0III" },
      ...
      { name:"\u03ba And", ra:[23.0, 40.0, 24.44], dec:[44.0, 20.0, 2.3], mag:4.15, spec:"B9IV" },
      ...
      { name:"\u03b7 And", ra:[0.0, 57.0, 12.43], dec:[23.0, 25.0, 3.9], mag:4.40, spec:"G8III" },
      ...
      { name:"\u03be And", ra:[1.0, 22.0, 20.39], dec:[45.0, 31.0, 43.5], mag:4.87, spec:"K0III" },
