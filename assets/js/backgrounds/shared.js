...
var consData = [
  { /* CASSIOPEIA */
    ...
    stars: [
,
    ],, dec:[56.0, 32.0, 14.7], mag:2.24, spec:"K0II-IIIvar" },
  ...
  { /* ORION */
    ...
    stars: [
,
    ],, dec:[-8.0, 12.0, 5.9], mag:0.18, spec:"B8Ia + B9V + B9V" },
  ...
  { /* LYRA */
    ...
    stars: [
,
    ],, dec:[38.0, 46.0, 58.8], mag:0.03, spec:"A0Vvar" },
  ...
  { /* CYGNUS */
    ...
    stars: [
,
    ],, dec:[45.0, 16.0, 49.2], mag:1.25, spec:"A2Ia" },
  ...
  { /* GEMINI */
    ...
    stars: [
,
    ],, dec:[28.0, 1.0, 34.7], mag:1.16, spec:"K0III" },
  ...
  { /* SCORPIUS */
    ...
    stars: [
,
    ],, dec:[-26.0, 25.0, 55.0], mag:0.91, spec:"M1.5Iab-b" },
      ...
      { name:"HD 144987", ra:[16.0, 9.0, 52.61], dec:[-33.0, 32.0, 44.5], mag:5.50, spec:"B8V" },
        ...
        connections: [[3, 5], [5, 0], [0, 4], [4, 2], [2, 1], [1, 6]],
        mainIndices: [0, 1, 2, 3, 4, 5, 6],
  },
  { /* ANDROMEDA */
    ...
    stars: [
,
    ],, dec:[29.0, 5.0, 27.0], mag:2.07, spec:"B9p" },
