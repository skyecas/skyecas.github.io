...
var consData = [
  { /* CASSIOPEIA */
    ...
    stars: [
      { name:"\u03b1 Cas", ra:[0.0, 40.0, 30.39], dec:[56.0, 32.0, 14.7], mag:2.24, spec:"K0II-IIIvar" },
      { name:"\u03b2 Cas", ra:[0.0, 9.0, 10.09], dec:[59.0, 9.0, 0.8], mag:2.28, spec:"F2III-IV" },
      { name:"\u03b3 Cas", ra:[0.0, 56.0, 42.5], dec:[60.0, 43.0, 0.3], mag:2.47, spec:"B0IV:evar" },
      { name:"\u03b4 Cas", ra:[1.0, 25.0, 48.6], dec:[60.0, 14.0, 7.5], mag:2.68, spec:"A5Vv SB" },
      { name:"\u03b5 Cas", ra:[1.0, 54.0, 23.68], dec:[63.0, 40.0, 12.5], mag:3.35, spec:"B2pvar" },
      { name:"\u03b7 Cas", ra:[0.0, 49.0, 5.1], dec:[57.0, 48.0, 59.6], mag:3.46, spec:"G0V SB" },
      { name:"\u03b6 Cas", ra:[0.0, 36.0, 58.27], dec:[53.0, 53.0, 49.0], mag:3.69, spec:"B2IV" },
      { name:"50 Cas", ra:[2.0, 3.0, 26.19], dec:[72.0, 25.0, 16.5], mag:3.95, spec:"A2V" },
      { name:"\u03ba Cas", ra:[0.0, 32.0, 59.99], dec:[62.0, 55.0, 54.4], mag:4.17, spec:"B1Ia" },
      { name:"\u03b8 Cas", ra:[1.0, 11.0, 5.93], dec:[55.0, 8.0, 59.8], mag:4.34, spec:"A7Vvar" },
      { name:"\u03b9 Cas", ra:[2.0, 29.0, 3.99], dec:[67.0, 24.0, 8.6], mag:4.46, spec:"A5p Sr" },
      ...
      { name:"\u03c1 Cas", ra:[23.0, 54.0, 23.04], dec:[57.0, 29.0, 57.8], mag:4.51, spec:"F8Ia0-M2I" },
      { name:"\u03c52 Cas", ra:[0.0, 56.0, 40.01], dec:[59.0, 10.0, 52.2], mag:4.62, spec:"G8III-IV" },
      ...
      { name:"HD 19275", ra:[3.0, 11.0, 56.24], dec:[74.0, 23.0, 37.9], mag:4.85, spec:"A2Vnn" },
      ...
      { name:"\u03bc Cas", ra:[1.0, 8.0, 12.92], dec:[54.0, 55.0, 27.2], mag:5.17, spec:"G5VIp/M5V" },
  ...
  { /* ORION */
    ...
    stars: [
      ...
      { name:"\u03b7 Ori", ra:[5.0, 24.0, 28.62], dec:[-2.0, 23.0, 49.7], mag:3.35, spec:"B1V + B2" },
  ...
  { /* LYRA */
    ...
    stars: [
      ...
      { name:"\u03b2 Lyr", ra:[18.0, 50.0, 4.79], dec:[33.0, 21.0, 45.6], mag:3.52, spec:"A8:V comp SB" },
      ...
      { name:"\u03bc Lyr", ra:[18.0, 24.0, 13.8], dec:[39.0, 30.0, 26.1], mag:5.11, spec:"A3IVn" },
  ...
  { /* CYGNUS */
    ...
    stars: [
      ...
      { name:"\u03b3 Cyg", ra:[20.0, 22.0, 13.7], dec:[40.0, 15.0, 24.1], mag:2.23, spec:"F8Ib" },
      { name:"\u03b5 Cyg", ra:[20.0, 46.0, 12.43], dec:[33.0, 58.0, 10.0], mag:2.48, spec:"K0III" },
      ...
      { name:"\u03b6 Cyg", ra:[21.0, 12.0, 56.18], dec:[30.0, 13.0, 37.5], mag:3.21, spec:"G8II SB" },
      ...
      { name:"\u03b7 Cyg", ra:[19.0, 56.0, 18.4], dec:[35.0, 5.0, 0.6], mag:3.89, spec:"K0IIIvar" },
      ...
      { name:"\u03c02 Cyg", ra:[21.0, 46.0, 47.61], dec:[49.0, 18.0, 34.5], mag:4.23, spec:"B3III" },
      { name:"33 Cyg", ra:[20.0, 13.0, 23.8], dec:[56.0, 34.0, 3.1], mag:4.28, spec:"A3IV-Vn" },
      { name:"\u03c5 Cyg", ra:[21.0, 17.0, 55.07], dec:[34.0, 53.0, 48.8], mag:4.41, spec:"B2Vne" },
      ...
      { name:"47 Cyg A", ra:[20.0, 33.0, 54.19], dec:[35.0, 15.0, 3.1], mag:4.61, spec:"K2Ib comp" },
      ...
      { name:"P Cyg", ra:[20.0, 17.0, 47.2], dec:[38.0, 1.0, 58.6], mag:4.77, spec:"B2pe" },
      ...
      { name:"\u03c8 Cyg", ra:[19.0, 55.0, 37.82], dec:[52.0, 26.0, 20.5], mag:4.91, spec:"A4Vn" },
      ...
      { name:"T Cyg", ra:[20.0, 47.0, 10.72], dec:[34.0, 22.0, 26.8], mag:4.93, spec:"K3IIIvar" },
      ...
      { name:"26 Cyg", ra:[20.0, 1.0, 21.55], dec:[50.0, 6.0, 16.8], mag:5.06, spec:"K1II-III" },
      { name:"56 Cyg", ra:[20.0, 50.0, 4.83], dec:[44.0, 3.0, 32.3], mag:5.06, spec:"A4me..." },
      { name:"75 Cyg", ra:[21.0, 40.0, 11.06], dec:[43.0, 16.0, 25.7], mag:5.09, spec:"M1IIIvar" },
      ...
      { name:"", ra:[19.0, 57.0, 13.86], dec:[40.0, 22.0, 4.2], mag:5.46, spec:"B5V" },
  ...
  { /* GEMINI */
    ...
    stars: [
      ...
      { name:"\u03b3 Gem", ra:[6.0, 37.0, 42.7], dec:[16.0, 23.0, 57.9], mag:1.93, spec:"A0IV" },
      { name:"\u03bc Gem", ra:[6.0, 22.0, 57.59], dec:[22.0, 30.0, 49.9], mag:2.87, spec:"M3.0III" },
      { name:"Castor B", ra:[7.0, 34.0, 36.0], dec:[31.0, 53.0, 19.0], mag:2.88, spec:"Am" },
      { name:"\u03b5 Gem", ra:[6.0, 43.0, 55.93], dec:[25.0, 7.0, 52.2], mag:3.06, spec:"G8Ib" },
      { name:"\u03b7 Gem", ra:[6.0, 14.0, 52.7], dec:[22.0, 30.0, 24.6], mag:3.31, spec:"M3III" },
      { name:"\u03be Gem", ra:[6.0, 45.0, 17.43], dec:[12.0, 53.0, 45.8], mag:3.35, spec:"F5IV" },
      { name:"\u03b4 Gem", ra:[7.0, 20.0, 7.39], dec:[21.0, 58.0, 56.4], mag:3.50, spec:"F0IV..." },
      { name:"\u03ba Gem", ra:[7.0, 44.0, 26.87], dec:[24.0, 23.0, 53.3], mag:3.57, spec:"G8III" },
      ...
      { name:"\u03b9 Gem", ra:[7.0, 25.0, 43.68], dec:[27.0, 47.0, 53.8], mag:3.78, spec:"G9III+..." },
      ...
      { name:"\u03c7 Gem", ra:[8.0, 3.0, 31.1], dec:[27.0, 47.0, 39.9], mag:4.94, spec:"K2III" },
  ...
  { /* SCORPIUS */
    ...
    stars: [
      ...
      { name:"\u03bb Sco", ra:[17.0, 33.0, 36.53], dec:[-37.0, 6.0, 13.5], mag:1.62, spec:"B2IV+DA7.9" },
      { name:"\u03b8 Sco", ra:[17.0, 37.0, 19.13], dec:[-42.0, 59.0, 52.2], mag:1.86, spec:"F1II" },
      { name:"\u03b4 Sco", ra:[16.0, 0.0, 20.01], dec:[-22.0, 37.0, 17.8], mag:2.29, spec:"B0.2IVe" },
      { name:"\u03b5 Sco", ra:[16.0, 50.0, 10.24], dec:[-34.0, 17.0, 33.4], mag:2.29, spec:"K2IIIb" },
      { name:"\u03ba Sco", ra:[17.0, 42.0, 29.28], dec:[-39.0, 1.0, 47.7], mag:2.39, spec:"B1.5III" },
      { name:"\u03b21 Sco", ra:[16.0, 5.0, 26.23], dec:[-19.0, 48.0, 19.4], mag:2.62, spec:"B0.5V" },
      { name:"\u03c5 Sco", ra:[17.0, 30.0, 45.84], dec:[-37.0, 17.0, 44.7], mag:2.70, spec:"B2IV" },
      { name:"\u03c4 Sco", ra:[16.0, 35.0, 52.96], dec:[-28.0, 12.0, 57.5], mag:2.82, spec:"B0V" },
      { name:"\u03c0 Sco", ra:[15.0, 58.0, 51.12], dec:[-26.0, 6.0, 50.6], mag:2.89, spec:"B1V + B2V" },
      ...
      { name:"\u03bc1 Sco", ra:[16.0, 51.0, 52.24], dec:[-38.0, 2.0, 50.4], mag:3.00, spec:"B1.5IV + B" },
      { name:"G Sco", ra:[17.0, 49.0, 51.45], dec:[-37.0, 2.0, 36.1], mag:3.19, spec:"K0/K1III" },
      ...
      { name:"\u03c1 Sco", ra:[15.0, 56.0, 53.09], dec:[-29.0, 12.0, 50.4], mag:3.87, spec:"B2IV/V" },
      { name:"\u03c91 Sco", ra:[16.0, 6.0, 48.43], dec:[-20.0, 40.0, 8.9], mag:3.93, spec:"B1V" },
      { name:"\u03bd Sco", ra:[16.0, 11.0, 59.74], dec:[-19.0, 27.0, 38.3], mag:4.00, spec:"B2IV" },
      { name:"H Sco", ra:[16.0, 36.0, 22.46], dec:[-35.0, 15.0, 19.3], mag:4.18, spec:"K5III" },
      { name:"N Sco", ra:[16.0, 31.0, 22.94], dec:[-34.0, 42.0, 15.6], mag:4.24, spec:"B2III-IV" },
      { name:"Q Sco", ra:[17.0, 36.0, 32.85], dec:[-38.0, 38.0, 5.5], mag:4.26, spec:"G8/K0III/IV" },
      { name:"\u03c92 Sco", ra:[16.0, 7.0, 24.3], dec:[-20.0, 52.0, 7.2], mag:4.31, spec:"G6/G8III" },
      ...
      { name:"\u03b61 Sco", ra:[16.0, 53.0, 59.73], dec:[-42.0, 21.0, 43.3], mag:4.70, spec:"B1Iae" },
      { name:"\u03be Sco A", ra:[16.0, 4.0, 22.1], dec:[-11.0, 22.0, 23.0], mag:4.77, spec:null },
      ...
      { name:"HD 161840", ra:[17.0, 49.0, 10.47], dec:[-31.0, 42.0, 11.5], mag:4.79, spec:"B8Ib/II" },
      ...
      { name:"HD 147513", ra:[16.0, 24.0, 1.24], dec:[-39.0, 11.0, 34.8], mag:5.37, spec:"G3/G5V" },
  ...
  { /* ANDROMEDA */
    ...
    stars: [
      ...
      { name:"\u03b31 And", ra:[2.0, 3.0, 53.92], dec:[42.0, 19.0, 47.5], mag:2.10, spec:"K3IIb" },
      ...
      { name:"\u03bf And", ra:[23.0, 1.0, 55.25], dec:[42.0, 19.0, 33.5], mag:3.62, spec:"B6pv SB" },
      { name:"\u03bb And", ra:[23.0, 37.0, 33.71], dec:[46.0, 27.0, 33.0], mag:3.81, spec:"G8III-IV" },
      ...
      { name:"\u03c5 And", ra:[1.0, 36.0, 47.98], dec:[41.0, 24.0, 23.0], mag:4.10, spec:"F8V" },
      { name:"\u03ba And", ra:[23.0, 40.0, 24.44], dec:[44.0, 20.0, 2.3], mag:4.15, spec:"B9IVn" },
      { name:"\u03c6 And", ra:[1.0, 9.0, 30.12], dec:[47.0, 14.0, 30.6], mag:4.26, spec:"B7III" },
      { name:"\u03b9 And", ra:[23.0, 38.0, 8.18], dec:[43.0, 16.0, 5.1], mag:4.29, spec:"B8V" },
      ...
      { name:"\u03b7 And", ra:[0.0, 57.0, 12.43], dec:[23.0, 25.0, 3.9], mag:4.40, spec:"G8III-IV" },
      ...
      { name:"\u03be And", ra:[1.0, 22.0, 20.39], dec:[45.0, 31.0, 43.5], mag:4.87, spec:"K0III-IV" },
      ...
      { name:"2 And", ra:[23.0, 2.0, 36.34], dec:[42.0, 45.0, 28.1], mag:5.09, spec:"A3Vn" },
